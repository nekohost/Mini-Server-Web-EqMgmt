...
// [의존성 관계] core.mjs의 JSONL·경로·이벤트 정규화 기능과 Codex session_meta/response_item 스키마에 의존한다.
// [변경 시 영향도] Codex 로그 스키마가 달라지면 알 수 없는 행을 추정하지 말고 fixture와 capability를 갱신해야 한다.

import { readdir, readFile } from 'node:fs/promises';
import os from 'node:os';
import path from 'node:path';
import { createEvent, extractCodexMessageText, normalizePathForComparison, parseJsonLines, sourceFingerprint } from './core.mjs';

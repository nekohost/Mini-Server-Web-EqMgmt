...
source_section_digest: FDABFC9B06D6BE3E45EB3E580572CC105C41C9D57DE839F0EBFEFE975EC8E11F
always_load: false
...
한 턴에서 작업 연속성을 위해 10개를 일시 초과한 경우 즉시 삭제하지 않고 다음 턴으로 유예한다. `scratch/` 임시 파일은 `Chat/`, `Plans/`, `Tasks/`, `Reports/` 영구 문서가 아니며 문서 생명주기 보존 대상에 포함하지 않는다.

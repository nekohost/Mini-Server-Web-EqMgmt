...
if (!['check', 'approved'].includes(process.env.EQM_DEPLOY_COMPACT_NAV)) throw new Error('Set EQM_DEPLOY_COMPACT_NAV=check or approved for this release.');
const data = {apply: process.env.EQM_DEPLOY_COMPACT_NAV === 'approved', head: gitRead(['rev-parse', 'HEAD']).trim(), pid: 81107, files: {}};

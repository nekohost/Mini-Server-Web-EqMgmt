...
if (!['check', 'approved'].includes(process.env.EQM_DEPLOY_HEADING_ROLLBACK)) throw new Error('Set EQM_DEPLOY_HEADING_ROLLBACK=check or approved for this release.');
const data = {apply: process.env.EQM_DEPLOY_HEADING_ROLLBACK === 'approved', head: gitRead(['rev-parse', 'HEAD']).trim(), pid: 84781, files: {}};

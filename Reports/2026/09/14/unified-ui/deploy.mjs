...
if (!['check', 'approved'].includes(process.env.EQM_DEPLOY_UNIFIED_UI)) throw new Error('Set EQM_DEPLOY_UNIFIED_UI=check or approved for this release.');
const data = {apply: process.env.EQM_DEPLOY_UNIFIED_UI === 'approved', head: gitRead(['rev-parse', 'HEAD']).trim(), pid: 86641, files: {}};

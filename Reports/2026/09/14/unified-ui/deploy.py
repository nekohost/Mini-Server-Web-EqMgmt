...
FILES = {"static/css/layout.css","static/js/menu_cards.js","static/js/session_timer.js","templates/miniserver_frame.html","templates/index.html","templates/roadmap_equipment.html","templates/master_management.html","templates/users_management.html","templates/permissions.html","templates/admin_center.html","templates/audit_logs.html","templates/access_logs.html","templates/access_logs_error_ips.html","templates/lineup_management.html","templates/approvals.html","templates/portal.html","templates/dashboard.html","templates/mypage.html","templates/maintenance_admin.html","templates/backup_restore.html"}
...
if not data["apply"]:
    ...
    sys.exit(0)
release = RELEASES / ("ui-unified-ui-" + datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ"))

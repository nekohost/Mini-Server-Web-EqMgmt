...
if (!['check', 'approved'].includes(process.env.EQM_DEPLOY_RESPONSIVE_SHELL)) throw new Error('Set EQM_DEPLOY_RESPONSIVE_SHELL=check or approved for this release.');
const data = {apply: process.env.EQM_DEPLOY_RESPONSIVE_SHELL === 'approved', head: gitRead(['rev-parse', 'HEAD']).trim(), pid: 83671, files: {}};

...
FILES = {"static/css/layout.css","static/js/navigation.js","static/js/menu_cards.js","static/js/session_timer.js","templates/miniserver_frame.html","templates/index.html","templates/master_management.html","templates/users_management.html","templates/admin_center.html","templates/access_logs.html","templates/access_logs_error_ips.html","templates/lineup_management.html","templates/permissions.html","templates/mypage.html"}
...
if not data["apply"]:
    ...
    sys.exit(0)
release = RELEASES / ("ui-responsive-shell-" + datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ"))

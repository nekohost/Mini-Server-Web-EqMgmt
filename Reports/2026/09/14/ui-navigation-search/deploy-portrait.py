...
FILES = {"static/css/layout.css","templates/miniserver_frame.html","templates/index.html","templates/mypage.html","templates/portal.html"}
...
if not data["apply"]:
    ...
    sys.exit(0)
release = RELEASES / ("ui-portrait-correction-" + datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ"))

...
FILES = {"static/css/layout.css","static/js/session_timer.js","static/js/roadmap_equipment.js","templates/miniserver_frame.html","templates/portal.html","templates/admin_center.html","templates/roadmap_equipment.html","templates/permissions.html","templates/audit_logs.html","templates/users_management.html","templates/approvals.html","templates/master_management.html","templates/access_logs.html","templates/access_logs_error_ips.html","templates/maintenance_admin.html","templates/backup_restore.html","templates/lineup_management.html","static/js/navigation.js","static/js/menu_cards.js"}
...
if not data["apply"]:
    ...
    sys.exit(0)
release = RELEASES / ("ui-navigation-search-" + datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ"))

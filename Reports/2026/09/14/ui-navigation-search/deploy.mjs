...
if (!['check', 'approved'].includes(process.env.EQM_DEPLOY_UX)) throw new Error('Set EQM_DEPLOY_UX=check or approved for this release.');
const data = {apply: process.env.EQM_DEPLOY_UX === 'approved', head: gitRead(['rev-parse', 'HEAD']).trim(), pid: 77507, files: {}};

...
- [001 실제 DB 구조 감사](./001_Backup_DB_Structure_Audit_Task.md) — 완료.
- [002 DB 계약·무결성 강화](./002_Database_Contract_and_Integrity_Hardening_Task.md) — 구현·검증·백업 서버 적용 완료, 주 서버 SSH 미연결.
...
- [006 장비 수정 카탈로그 선택 복원](./006_Equipment_Edit_Catalog_Selection_Task.md) — 백업 서버 배포·Python 69건·HTTP 확인 완료, 인증 브라우저 확인 대기.
